...
// App is the giving you the structure of the redovc app.
type App struct {
...
// NewApp is creating a new redovc app.
func NewApp() *App {
	app := &App{
		TodoList:  &TodoList{},
...
// InitializeRepo is initializing redovc repo.
...
func (a *App) AddTodo(input string) {
	...
	if err != nil {
		...
		fmt.Println("I need more information. Try something like 'redovc a chat with #bob +AcmeProject due:tom'")
		return
	}
