...
// ProcessEvents processes all events that occurred when ultodo ran and write them to a log file.
...
// LoadSyncedLists - load all currently synced lists from ~/.config/ultodo/synced_lists.json
